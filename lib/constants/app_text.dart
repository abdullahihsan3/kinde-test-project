...
const TextStyle kManropeText = TextStyle(fontFamily: 'Manrope');
const TextStyle kPTSansText = TextStyle(fontFamily: 'PTSans');
...
/// Font Weights
FontWeight kFwBold = FontWeight.w600;
FontWeight kFwMedium = FontWeight.w500;
FontWeight kFwRegular = FontWeight.w400;
